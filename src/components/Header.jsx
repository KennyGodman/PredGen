...
function PredGenLogo({ size = 26 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="PredGen logo mark">
      <path d="M20 4L36 32H4L20 4Z" fill="#00b4c8" opacity="0.9" />
      <path d="M20 12L30 28H10L20 12Z" fill="#ffffff" opacity="0.9" />
      <path d="M20 20L25 28H15L20 20Z" fill="#00b4c8" opacity="0.8" />
    </svg>
  );
}

export default function Header({ activeTab, setActiveTab, walletAddress, walletBalance, search, onSearchChange }) {
  const navTabs = [
            ...
            {walletOpen && (
              <div style={{
                ...
                <button
                  ...
                  onClick={() => { setWalletOpen(false); alert('Disconnected (demo)'); }}
                  style={{
                    width: '100%',
                    display: 'flex',
                    alignItems: 'center',
